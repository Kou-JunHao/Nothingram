...
-keepclassmembernames,allowshrinking class uno.skkk.nothingram.MessageDetailsActivity$TextDetailSimpleCell { <fields>; }
-keepclassmembernames,allowshrinking class uno.skkk.nothingram.settings.AccountCell { <fields>; }
-keepclassmembernames,allowshrinking class uno.skkk.nothingram.settings.EmojiSetCell { <fields>; }
-keepclassmembernames,allowshrinking class uno.skkk.nothingram.settings.NekoChatSettingsActivity$StickerSizeCell { <fields>; }
